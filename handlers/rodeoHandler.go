...
//
// Locate the rodeo whose ID value matches the ID parameter sent by the client, then returns the rodeo as a response.
//
// ---
// parameters:
//   - name: id
...
//
// Locate the rodeo whose ID value matches the ID parameter sent by the client, delete the rodeo from the database, return a successful deletion message.
//
// ---
// parameters:
//   - name: id
...
//
// Insert a new rodeo into the database from JSON received in the request body, returns the new rodeo as a response.
//
// ---
// produces:
// - application/json
...
//
// Update an existing rodeo whose ID value matches the ID parameter sent by the client with the request body from the PUT request, then returns the updated rodeo as a response.
//
// ---
// parameters:
//   - name: id
